    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.textContainer}>
                <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.25 }}>Nikola
                    Tesla (1856-1943) was a brilliant Serbian-American inventor, electrical engineer, and visionary. He
                ...
                <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.25 }}>Despite his
                    extraordinary contributions to science and technology, Tesla faced periods of obscurity and
