...
import tesla_background from "../../public/images/tesla_background_upscaled.webp";
        ...
        <div id={"about"}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.content}>
                    <p>
                        Nikola Tesla, a brilliant Serbian-American inventor, electrical engineer, and visionary, left an
                        ...
                        him into the forefront of innovation. From an early age, Tesla exhibited an exceptional aptitude
                        for understanding the complexities of electricity and energy. After completing his studies in
                        engineering and physics, he embarked on a journey that would transform the world&apos;s
                        understanding of electrical systems. Tesla&apos;s most celebrated contribution lies in his groundbreaking
                        work on alternating current (AC) electrical systems. By championing AC over direct current (DC), he revolutionized
                        the way electricity was generated, transmitted, and utilized. His ingenious inventions paved the way for
                    ...
                    <p>
                        Central to Tesla&apos;s legacy is the invention of the Tesla coil, a resonant transformer circuit that
                        ...
                        later shape the modern world of telecommunications. Yet, Tesla&apos;s innovations extended far beyond established boundaries. He envisioned a future
                    ...
                    <p>
                        ...
                        scientific achievements. Today, Tesla&apos;s legacy is experiencing a resurgence of appreciation. His imaginative ideas
                        have found renewed relevance in the fields of renewable energy, wireless technology, and beyond. The
                        legacy of Nikola Tesla serves as a guiding light, encouraging us to explore the frontiers of
                        innovation and push the boundaries of what is possible.
                    </p>
                </div>
            </div>
        </div>
