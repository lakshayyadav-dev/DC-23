...
import tesla_coil_1 from "../public/images/tesla_coil_1.png";
import tesla_coil_2 from "../public/images/tesla_coil_2.png";
import tesla_coil_3 from "../public/images/tesla_coil_3.png";

const TeslaCoil = () => {
    return (
        <div className={styles.container}>
            <div className={styles.coverContent}>
                <Image src={tesla_coil_1} alt={"1"} className={styles.coverImage}/>
                <div className={styles.coverContentText}>
                    ...
                    <p>
                        ...
                        genius,
                        showcasing his profound understanding of electromagnetism, resonance, and the manipulation of
                    ...
                    <p>
                        ...
                        non Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut.
                    </p>
                    <p>
            ...
            <Image src={tesla_coil_2} alt={"2"}/>

            <div className={styles.endContent}>
                <div className={styles.endContentText}>
                    <p>
                        Tesla&apos;s ambitious vision for wireless power transmission was grounded in the belief that energy
                        ...
                        Tesla&apos;s lifetime, his work laid the foundation for the development of wireless communication
                    ...
                    <p>
                        ...
                        Tesla coil&apos;s influence extended beyond the realm of spectacular electrical displays to the realm
                    ...
                    <p>
                        ...
                        a tool for experimentation, education, and entertainment. The device&apos;s ability to generate high
                    ...
                    <p>
                        ...
                        innovation that echoes Tesla&apos;s own pursuit of the unknown. Today&apos;s engineers and enthusiasts
                ...
                <Image src={tesla_coil_3} alt={"1"} className={styles.endImage}/>
            </div>
        </div>
    );
};
